...
var RpcChannel = /** @class */ (function () {
    ...
    RpcChannel.prototype.createRpcRequest = function (method, requestData) {
        ...
        // create rpc message
        var rpcRequest = this.rpc_request_type.create(rpcRequestData);
        return rpcRequest;
    };
    RpcChannel.prototype.sendRpcRequest = function (rpcRequest) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        rpcRequestBuff = this.rpc_request_type.encode(rpcRequest).finish();
                        // send over socket
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, rpcResponseData];
                }
            });
        });
    };
    RpcChannel.prototype.callMethod = function (method, requestData, callback) {
        return __awaiter(this, void 0, void 0, function () {
            var rpcRequest, rpcResponse, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        rpcRequest = this.createRpcRequest(method, requestData);
